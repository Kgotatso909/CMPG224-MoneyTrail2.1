 var selectedDate = null; // Store the selected date globally
        ...
        menu.style.transition = "406ms";
        btn1.style.transform = "translate(220px)";
        btn1.style.transition = "406ms";
        btn2.style.transform = "translate(220px)";
        btn2.style.transition = "406ms";
    ...
    function cls() {
        ...
        setTimeout(function () {
            btn1.style.transform = "translate(0px)";
            btn1.style.transition = "406ms";
            btn2.style.transform = "translate(0px)";
            btn2.style.transition = "406ms";
